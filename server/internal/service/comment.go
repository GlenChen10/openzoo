...
func CreateComment(ctx context.Context, workspaceID, issueID, userID, content, parentID string) (*Comment, error) {
	...
	_, err := pool.Exec(ctx,
		`INSERT INTO comments (id, issue_id, author_type, author_id, content, type, parent_id, created_at, updated_at)
		 VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)`,
		c.ID, c.IssueID, c.AuthorType, c.AuthorID, c.Content, c.Type, c.ParentID, c.CreatedAt, c.UpdatedAt)
	if err != nil {
		return nil, err
	}
