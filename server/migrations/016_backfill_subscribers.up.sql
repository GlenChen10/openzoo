...
SELECT id, creator_type, creator_id, 'creator' FROM issue ON CONFLICT DO NOTHING;

INSERT INTO issue_subscriber (issue_id, user_type, user_id, reason)
SELECT id, assignee_type, assignee_id, 'assignee' FROM issue
...
FROM comment c ON CONFLICT DO NOTHING;
